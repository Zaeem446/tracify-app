...
const L10N = {
    ...
    de: {
        home:        { title: "Jedes Handy orten — Jeden überall sofort verfolgen | Tracify", description: "Verfolgen Sie jeden überall und finden Sie sofort seinen Standort per Telefonnummer. Einverständnisbasierter Echtzeit-Handy-Tracker. iOS + Android, keine App-Installation. 24-Stunden-Test für $0,50.", h1: "Jedes Handy, überall orten" },
    ...
    fr: {
        home:        { title: "Localiser n'importe quel téléphone — Suivre n'importe qui, n'importe où, instantanément | Tracify", description: "Suivez n'importe qui n'importe où et trouvez sa localisation instantanément par numéro de téléphone. Traceur de téléphone en temps réel basé sur le consentement. iOS + Android, sans installation d'app. Essai $0,50.", h1: "Localisez n'importe quel téléphone, partout" },
    ...
    pt: {
        home:        { title: "Localize qualquer telefone — Rastreie qualquer pessoa, em qualquer lugar, instantaneamente | Tracify", description: "Rastreie qualquer pessoa em qualquer lugar e encontre a sua localização instantaneamente pelo número de telefone. Rastreador de telefone em tempo real baseado em consentimento. iOS + Android, sem instalar app. Teste $0,50.", h1: "Localize qualquer telefone, em qualquer lugar" },
    ...
    pt_BR: {
        home:        { title: "Localize qualquer telefone — Rastreie qualquer pessoa, em qualquer lugar, instantaneamente | Tracify", description: "Rastreie qualquer pessoa em qualquer lugar e encontre a localização dela instantaneamente pelo número. Rastreador de telefone em tempo real baseado em consentimento. iOS + Android, sem app. Teste $0,50.", h1: "Localize qualquer telefone, em qualquer lugar" },
        howItWorks:  { title: "Como o Tracify funciona — Rastreie em 3 passos", description: "Veja como o Tracify localiza qualquer telefone em três passos: insira o número, envie um SMS e receba as coordenadas GPS." },
    ...
    nl: {
        home:        { title: "Zoek elke telefoon — Volg iedereen, overal, direct | Tracify", description: "Volg iedereen overal en vind zijn locatie direct via telefoonnummer. Realtime telefoontracker op basis van toestemming. iOS + Android, geen app-installatie. Proef van $0,50.", h1: "Vind elke telefoon, overal" },
    ...
    tr: {
        home:        { title: "Her Telefonu Bul — Herkesi, Her Yerde, Anında Takip Et | Tracify", description: "Herhangi birini her yerde takip edin ve telefon numarasından konumunu anında bulun. Onaya dayalı gerçek zamanlı telefon takip. iOS + Android, uygulama yüklemeden. $0,50 deneme.", h1: "Herhangi bir telefonu, her yerde bulun" },
    ...
    ar: {
        home:        { title: "حدد موقع أي هاتف — تتبع أي شخص في أي مكان فوراً | Tracify", description: "تتبع أي شخص في أي مكان واعثر على موقعه فوراً عبر رقم الهاتف. متتبع هاتف في الوقت الفعلي قائم على الموافقة. iOS + Android بدون تثبيت تطبيق. تجربة $0.50.", h1: "حدد موقع أي هاتف في أي مكان" },
    ...
    he: {
        home:        { title: "אתר כל טלפון — עקוב אחרי כל אחד בכל מקום, מיידית | Tracify", description: "עקוב אחרי כל אחד בכל מקום ומצא את המיקום שלו מיידית לפי מספר טלפון. מאתר טלפון בזמן אמת מבוסס הסכמה. iOS + Android, בלי התקנת אפליקציה. ניסיון $0.50.", h1: "אתר כל טלפון, בכל מקום" },
    ...
    ja: {
        home:        { title: "どの電話でも特定 — 誰でもどこでも今すぐ追跡 | Tracify", description: "電話番号で誰でもどこでも追跡し、位置を今すぐ特定。同意ベースのリアルタイム電話トラッカー。iOS + Android、アプリ不要。$0.50トライアル。", h1: "どの電話でも、どこでも特定" },
    ...
    ko: {
        home:        { title: "어떤 휴대폰이든 찾기 — 누구나 어디서든 즉시 추적 | Tracify", description: "전화번호로 누구나 어디서든 추적하고 즉시 위치 확인. 동의 기반 실시간 휴대폰 추적기. iOS + Android, 앱 설치 불필요. $0.50 체험.", h1: "어떤 휴대폰이든, 어디서든 찾기" },
    ...
    zh: {
        home:        { title: "定位任何手机 — 随时随地即刻追踪任何人 | Tracify", description: "通过手机号码随时随地追踪任何人,即刻获取其位置。基于同意的实时手机追踪。iOS + Android,无需安装应用。$0.50试用。", h1: "随时随地定位任何手机" },
    ...
    'zh-TW': {
        home:        { title: "定位任何手機 — 隨時隨地即時追蹤任何人 | Tracify", description: "透過手機號碼隨時隨地追蹤任何人,即時取得其位置。基於同意的即時手機追蹤。iOS + Android,無需安裝應用程式。$0.50試用。", h1: "隨時隨地定位任何手機" },
    ...
    zh_HK: {
        home:        { title: "定位任何手機 — 隨時隨地即時追蹤任何人 | Tracify", description: "透過手機號碼隨時隨地追蹤任何人,即時取得其位置。基於同意嘅即時手機追蹤。iOS + Android,無需安裝應用程式。$0.50試用。", h1: "隨時隨地定位任何手機" },
    ...
    hi: {
        home:        { title: "कोई भी फोन खोजें — किसी को भी कहीं भी तुरंत ट्रैक करें | Tracify", description: "फोन नंबर से किसी को भी कहीं भी ट्रैक करें और उनका स्थान तुरंत खोजें। सहमति-आधारित रीयल-टाइम फोन ट्रैकर। iOS + Android, बिना ऐप इंस्टॉल किए। $0.50 ट्रायल।", h1: "कोई भी फोन, कहीं भी खोजें" },
    ...
    th: {
        home:        { title: "ค้นหาโทรศัพท์เครื่องใดก็ได้ — ติดตามทุกคนได้ทุกที่ทันที | Tracify", description: "ติดตามทุกคนได้ทุกที่และค้นหาตำแหน่งของพวกเขาทันทีจากหมายเลขโทรศัพท์ เครื่องติดตามโทรศัพท์แบบเรียลไทม์ที่ใช้ความยินยอม iOS + Android ไม่ต้องติดตั้งแอป ทดลอง $0.50", h1: "ค้นหาโทรศัพท์ได้ทุกที่" },
    ...
    bn: {
        home:        { title: "যেকোনো ফোন খুঁজুন — যেকোনো কাউকে যেকোনো জায়গায় তাৎক্ষণিকভাবে ট্র্যাক করুন | Tracify", description: "ফোন নম্বর দিয়ে যেকোনো কাউকে যেকোনো জায়গায় ট্র্যাক করুন এবং তাদের অবস্থান তাৎক্ষণিকভাবে খুঁজে পান। সম্মতি-ভিত্তিক রিয়েল-টাইম ফোন ট্র্যাকার। iOS + Android, অ্যাপ ইনস্টল ছাড়া। $0.50 ট্রায়াল।", h1: "যেকোনো ফোন, যেকোনো জায়গায় খুঁজুন" },
    ...
    vi: {
        home:        { title: "Định vị mọi điện thoại — Theo dõi bất kỳ ai, ở bất kỳ đâu, ngay lập tức | Tracify", description: "Theo dõi bất kỳ ai ở bất kỳ đâu và tìm vị trí của họ ngay lập tức qua số điện thoại. Trình theo dõi điện thoại thời gian thực dựa trên sự đồng ý. iOS + Android, không cần cài ứng dụng. Dùng thử $0.50.", h1: "Định vị mọi điện thoại ở mọi nơi" },
    ...
    hu: {
        home:        { title: "Találj meg bármelyik telefont — Kövess bárkit, bárhol, azonnal | Tracify", description: "Kövess bárkit bárhol, és találd meg a helyét azonnal telefonszám alapján. Beleegyezés alapú valós idejű telefon nyomkövető. iOS + Android, alkalmazás telepítés nélkül. $0,50 próba.", h1: "Találj meg bármelyik telefont, bárhol" },
    ...
    et: {
        home:        { title: "Leia iga telefon — Jälgi kedagi, kõikjal, kohe | Tracify", description: "Jälgi kedagi kõikjal ja leia tema asukoht kohe telefoninumbri järgi. Nõusolekupõhine reaalajas telefoni jälgija. iOS + Android, ilma rakenduse paigaldamiseta. $0,50 prooviperiood.", h1: "Leia iga telefon, kõikjal" },
    ...
    lv: {
        home:        { title: "Atrodiet jebkuru telefonu — Izsekojiet ikvienam, jebkur, uzreiz | Tracify", description: "Izsekojiet ikvienam jebkur un atrodiet viņa atrašanās vietu uzreiz pēc telefona numura. Uz piekrišanas balstīts reāllaika telefona izsekotājs. iOS + Android, bez lietotnes uzstādīšanas. $0,50 izmēģinājums.", h1: "Atrodiet jebkuru telefonu, jebkur" },
    ...
    lt: {
        home:        { title: "Raskite bet kurį telefoną — Sekite bet ką, bet kur, akimirksniu | Tracify", description: "Sekite bet ką bet kur ir akimirksniu raskite jo vietą pagal telefono numerį. Sutikimu pagrįstas realaus laiko telefono sekiklis. iOS + Android, be programėlės diegimo. $0,50 bandymas.", h1: "Raskite bet kurį telefoną, bet kur" },
    ...
    sv: {
        home:        { title: "Hitta vilken telefon som helst — Spåra vem som helst, var som helst, direkt | Tracify", description: "Spåra vem som helst var som helst och hitta deras plats direkt via telefonnummer. Samtyckesbaserad realtids telefonspårare. iOS + Android, utan app-installation. $0,50 prov.", h1: "Hitta vilken telefon som helst, var som helst" },
    ...
    da: {
        home:        { title: "Find enhver telefon — Spor enhver, hvor som helst, øjeblikkeligt | Tracify", description: "Spor enhver hvor som helst og find deres placering øjeblikkeligt via telefonnummer. Samtykkebaseret realtids telefonsporer. iOS + Android, uden app-installation. $0,50 prøveperiode.", h1: "Find enhver telefon, hvor som helst" },
    ...
    sl: {
        home:        { title: "Poiščite kateri koli telefon — Sledite komur koli, kjer koli, takoj | Tracify", description: "Sledite komur koli kjer koli in takoj poiščite njegovo lokacijo po telefonski številki. Sledenje telefona v realnem času na podlagi soglasja. iOS + Android, brez namestitve aplikacije. $0,50 preizkus.", h1: "Poiščite kateri koli telefon, kjer koli" },
    ...
    tk: {
        home:        { title: "Islendik telefony tapyň — Islendik ýerde, islendik adamy derrew yzarlaň | Tracify", description: "Islendik ýerde islendik adamy yzarlaň we telefon belgisi boýunça ýerleşýän ýerini derrew tapyň. Ylalaşyga esaslanýan hakyky wagtda telefon yzarlaýjy. iOS + Android, programma oturtmazdan. $0,50 synag.", h1: "Islendik telefony, islendik ýerde tapyň" },
